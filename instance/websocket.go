...
err = c.Conn.WriteJSON(&Event{
	...
	Data: Data{
		ClientState: ClientState{
			...
			UserDMsettingsVersion:    -1, // Novo campo adicionado pelo Discord
		},
		Identify: Identify{
			Token: in.Token,
			Properties: Properties{
				OS:                "Windows",
				Browser:           "Chrome",
				Device:            "", // Manter vazio é mais seguro
				SystemLocale:      "pt-BR", // Simula um sistema em português
				BrowserUserAgent:  in.UserAgent, // Puxa do config.yml
				BrowserVersion:    "126.0.0.0",  // Versão moderna do Chrome
				OSVersion:         "10",
				ReleaseChannel:    "stable",
				ClientBuildNumber: 283911, // <--- NÚMERO DE BUILD ATUALIZADO
			},
			Capabilities: 8189, // Capabilities atualizadas
			Presence: Presence{
				Status: presence,
				Since:  0,
				AFK:    false,
