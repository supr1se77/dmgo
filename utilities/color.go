...
func LogInfo(format string, a ...any) {
	color.Printf("<fg=white>[</><fg=magenta;op=bold>INFO   </><fg=white>]</><fg=white>[</><fg=white;op=bold>%s</><fg=white>]</> » %s\n", time.Now().Format("15:04:05"), fmt.Sprintf(format, a...))
}
...
func LogWarn(format string, a ...any) {
	color.Printf("<fg=white>[</><fg=magenta;op=bold>WARNING</><fg=white>]</><fg=white>[</><fg=white;op=bold>%s</><fg=white>]</> » %s\n", time.Now().Format("15:04:05"), fmt.Sprintf(format, a...))
}

func LogLocked(format string, a ...any) {
	color.Printf("<fg=white>[</><fg=magenta;op=bold>LOCKED </><fg=white>]</><fg=white>[</><fg=white;op=bold>%s</><fg=white>]</> » %s\n", time.Now().Format("15:04:05"), fmt.Sprintf(format, a...))
}

func CaptchaDetected(token string, key string) {
	color.Printf("<fg=white>[</><fg=magenta;op=bold>CAPTCHA</><fg=white>]</><fg=white>[</><fg=white;op=bold>%s</><fg=white>]</> » Token %s Captcha Detected [%s]\n", time.Now().Format("15:04:05"), token, key)
}
...
func UserInput(format string, a ...any) string {
	...
	var out string
	color.Printf("<fg=white>[</><fg=magenta;op=bold>INPUT  </><fg=white>]</><fg=white>[</><fg=white;op=bold>%s</><fg=white>]</> %s » ", time.Now().Format("15:04:05"), fmt.Sprintf(format, a...))
...
func PrintMenu(a []string) {
	for i := 1; i < len(a)+1; i++ {
		if i < 10 {
			color.Printf("<fg=white>[</><fg=magenta;op=bold>0%d</><fg=white>]</> » %s\n", i, a[i-1])
		} else {
			color.Printf("<fg=white>[</><fg=magenta;op=bold>%d</><fg=white>]</> » %s\n", i, a[i-1])
		}
	}
}
...
func PrintMenu2(a []string) {
	for i := 0; i < len(a); i++ {
		if i < 10 {
			color.Printf("<fg=white>[</><fg=magenta;op=bold>00%d</><fg=white>]</> » %s\n", i, a[i])
		} else if i < 100 && i >= 10 {
			color.Printf("<fg=white>[</><fg=magenta;op=bold>0%d</><fg=white>]</> » %s\n", i, a[i])
		} else {
			color.Printf("<fg=white>[</><fg=magenta;op=bold>%d</><fg=white>]</> » %s\n", i, a[i])
